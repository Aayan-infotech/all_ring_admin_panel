...
//   // State variables
//   const [mentorCurrentUsers, setMentorCurrentUsers] = useState([]);
...
//   const fetchMentorUsers = async (mentorId) => {
//   try {
//     const token = localStorage.getItem('adminToken');
//     const response = await axios.get(
//       `http://54.205.149.77:5010/api/admin/getMentorUsers/${mentorId}`,
//       { headers: { Authorization: `Bearer ${token}` } }
//     );
//     setMentorCurrentUsers(response.data.users || []);
//   } catch (error) {
//     console.error('Error fetching mentor users:', error);
//     toast.error('Failed to load mentor users');
//     setMentorCurrentUsers([]);
//   }
// };
...
//   // const handlePageChange = (page) => {
//   //   setCurrentPage(page);
//   //   fetchMentors(page, itemsPerPage);
//   // };
...
//   // Initial data fetch
//   useEffect(() => {
//     fetchMentors(currentPage, itemsPerPage);
//     fetchLocations();
//   }, []);
...
//       {/* Filters Section - Updated to match your Mentors component */}
...
//   onShow={() => selectedUser && fetchMentorUsers(selectedUser._id)}
//   onHide={() => {
//     setShowAssignModal(false);
//     setSelectedInstructors([]);
//     setSelectedUsers([]);
...
//       const isAssignedToMentor = mentorCurrentUsers.some(u => u._id === user._id);
//       return (
//         <ListGroup.Item
//           key={user._id}
//           action
...
//             backgroundColor:
//               isAssignedToMentor
//                 ? 'rgba(25, 135, 84, 0.2)' // More visible green for already assigned
...
//               />
//               <Badge
//                 bg={isAssignedToMentor ? 'success' : 'secondary'}
//                 className="position-absolute top-0 start-100 translate-middle"
//                 pill
//               >
//                 {isAssignedToMentor ? (
...
//         <small>
//           {selectedUsers.filter(u => mentorCurrentUsers.some(mu => mu._id === u._id)).length} already assigned
//         </small>
//       </div>
//     </Card.Header>
//     <Card.Body className="p-3">
...
//           const isCurrent = mentorCurrentUsers.some(u => u._id === user._id);
//           return (
//             <Badge 
//               key={user._id} 
//               pill
//               className="d-flex align-items-center p-2"
//               style={{ 
//                 backgroundColor: isCurrent ? 'var(--success)' : 'var(--primary)',
//                 borderRadius: '20px',
...
//               {user.name}
//               {isCurrent && (
//                 <span className="ms-1" title="Already assigned to mentor">✓</span>
//               )}
//               <button 
//                 type="button" 
//                 className="btn-close btn-close-white ms-2" 
