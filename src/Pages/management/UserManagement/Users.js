...
//     await axios.put(
//       `http://localhost:5010/api/admin/changeUserPassword/${selectedUserId}`,
//       {
//         newPassword,
//         confirmPassword,
//       },
...
//     try {
//       setLoading(true);
//       const res = await axios.get('http://localhost:5010/api/admin/getRegister/user', {
...
// //       `http://localhost:5010/api/auth/update-user/${editingUser._id}`,
// //       formDataToSend,
// //       {
// //         headers: {
// //           'Authorization': `Bearer ${token}`,
...
//     try {
//       await axios.patch(
//         `http://localhost:5010/api/admin/editUserStatus/${user._id}`,
