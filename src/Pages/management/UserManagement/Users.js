...
//     await axios.put(
//       `http://98.87.121.113:5010/api/admin/changeUserPassword/${selectedUserId}`,
//       {
//         newPassword,
//         confirmPassword,
//       },
...
//     try {
//       setLoading(true);
//       const res = await axios.get('http://98.87.121.113:5010/api/admin/getRegister/user', {
...
// //       `http://98.87.121.113:5010/api/auth/update-user/${editingUser._id}`,
// //       formDataToSend,
// //       {
// //         headers: {
// //           'Authorization': `Bearer ${token}`,
...
//     try {
//       await axios.patch(
//         `http://98.87.121.113:5010/api/admin/editUserStatus/${user._id}`,
