...
const NotificationCreator = () => {
  ...
  const handleSubmit = (e) => {
    e.preventDefault();
    console.log('Notification created:', { type: notificationType, template: selectedTemplate, ...formData });
    alert('Notification created successfully!');
  };

  const getIcon = () => {
    switch(notificationType) {
      case 'class': return <ClassIcon className="text-white me-2" />;
      case 'quote': return <QuoteIcon className="text-white me-2" />;
      case 'event': return <EventIcon className="text-white me-2" />;
      default: return null;
    }
  };
...
<div className="mb-4">
  <label className="form-label small text-muted mb-2">SELECT NOTIFICATION TYPE</label>
  <select
  ...
  >
    ...
    <option value="event">Upcoming Event Invitation</option>
      ...
      {notificationType && (
        <div className="mb-4">
          <label className="form-label small text-muted mb-2">CHOOSE A TEMPLATE</label>
            ...
            {templates[notificationType].map(template => (
              ...
              >
                ...
                <div className="position-absolute bottom-0 start-0 end-0 p-3 bg-white bg-opacity-90">
                  <h6 className="fw-bold mb-0" style={{ color: 'var(--secondary)' }}>{template.name}</h6>
        ...
        <div className="row g-4">
          ...
          <div className="col-lg-6">
            <div className="card border-0 shadow-sm">
              <div className="card-body p-4">
                <h5 className="mb-4 fw-medium" style={{ color: 'var(--secondary)' }}>Notification Details</h5>
                <form onSubmit={handleSubmit}>
                  ...
                  {(notificationType === 'class' || notificationType === 'event') && (
                    ...
                    <>
                      <div className="mb-3">
                        ...
                        <div className="input-group">
                          <span className="input-group-text" style={{ backgroundColor: 'var(--accent)', borderColor: 'var(--secondary)' }}>
          ...
          <div className="col-lg-6">
            <div className="card border-0 shadow-sm h-100">
              <div className="card-body p-4">
                <h5 className="mb-4 fw-medium" style={{ color: 'var(--secondary)' }}>Preview</h5>
                <div 
                ...
                >
                  <div className="d-flex align-items-center mb-3">
                    <div 
                      ...
                      style={{ 
                        backgroundColor: notificationType === 'class' ? 'var(--primary)' : 
                                      notificationType === 'quote' ? 'var(--success)' : 'var(--warning)',
                        width: '40px',
                        height: '40px'
                      }}
                    >
                    ...
                    <span 
                      ...
                      style={{ 
                        color: notificationType === 'class' ? 'var(--primary)' : 
                              notificationType === 'quote' ? 'var(--success)' : 'var(--warning)'
                      }}
                    >
                  ...
                  <p className="mb-4 flex-grow-1" style={{ color: 'var(--text-primary)' }}>
                    ...
                    <>
                      ...
                      <div className="d-flex gap-4 mb-3">
                        <div className="d-flex align-items-center">
                          <BookIcon className="me-2" style={{ color: 'var(--primary)' }} />
                          <small style={{ color: 'var(--text-primary)' }}>
                            {formData.className || 'Class Name'}
                          </small>
                        </div>
                        <div className="d-flex align-items-center">
                          <PersonIcon className="me-2" style={{ color: 'var(--primary)' }} />
                          <small style={{ color: 'var(--text-primary)' }}>
                  ...
                  {(notificationType === 'class' || notificationType === 'event') && (
                    <>
                      ...
                      <div className="d-flex gap-4">
                        <div className="d-flex align-items-center">
                          <DateIcon className="me-2" style={{ color: 'var(--primary)' }} />
                          <small style={{ color: 'var(--text-primary)' }}>
                            {formData.date || 'Date'}
                          </small>
                        </div>
                        <div className="d-flex align-items-center">
                          <TimeIcon className="me-2" style={{ color: 'var(--primary)' }} />
                          <small style={{ color: 'var(--text-primary)' }}>
                            {formData.time || 'Time'}
                          </small>
                        </div>
