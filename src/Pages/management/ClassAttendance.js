...
// const sampleData = [
//   { id: 1, title: 'Yoga Basics', location: 'Hall A', instructor: 'John Doe', status: 'upcoming' },
//   { id: 2, title: 'Mindfulness 101', location: 'Room 3', instructor: 'Jane Smith', status: 'live' },
//   { id: 3, title: 'Fitness Flow', location: 'Gym', instructor: 'Ravi Kumar', status: 'past' },
// ];
...
//     title: '', location: '', instructor: '', status: 'upcoming'
//   });
...
//     setShowForm(false);
//     setNewEntry({ title: '', location: '', instructor: '', status: 'upcoming' });
//   };
