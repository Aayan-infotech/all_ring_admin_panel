...
//     try {
//       const token = localStorage.getItem('adminToken');
//       const res = await axios.get(`http://54.205.149.77:5010/api/mediaAdmin/getAllMedia/${classId}`, {
//         headers: {
//           Authorization: `Bearer ${token}`,
//         },
//       });
...
//   try {
//     const token = localStorage.getItem("adminToken");
//     await axios.delete(`http://54.205.149.77:5010/api/mediaAdmin/deleteMedia/${classId}/${mediaId}`, {
//       headers: {
//         Authorization: `Bearer ${token}`,
//       },
//     });
