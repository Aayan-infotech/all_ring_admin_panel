...
// import { PencilSquare, Trash, XLg,CheckCircleFill ,XCircleFill} from 'react-bootstrap-icons';
...
//     const newStatus = prisoner.status === 'Active' ? 'Inactive' : 'Active';
//     try {
...
//     padding: '0 5px',
//     color: 
//       p.status === 1 ? 'var(--danger)' : 
//      p.status === 2 ? 'var(--success)' : 'gray',
//     cursor: 'pointer', 
//   }}
// >
//   {p.status === 1 ? (
